...
public class MerchandiseImpl implements Merchandise {
	@Id
	@SequenceGenerator(name = "MERCHANDISE_ID_GENERATOR", 
					   sequenceName = "MERCHANDISE_SEQ", allocationSize = 1)	
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "MERCHANDISE_ID_GENERATOR")
	private int id;
